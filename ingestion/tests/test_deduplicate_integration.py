...
def test_integration_parse_filter_dedup_same_object_once():
...
def test_integration_parse_filter_dedup_two_objects_both_kept():
...
def test_integration_parse_filter_dedup_inprogress_dropped_then_dedup():
